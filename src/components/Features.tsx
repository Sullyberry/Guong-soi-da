...
const features = [
  {
    title: "Phân tích chỉ số da",
    description: "Hệ thống camera và cảm biến chuyên dụng ẩn dưới lớp kính sẽ tự động quét diện rộng khuôn mặt để phân tích các chỉ số (mụn, dầu, lỗ chân lông, thâm, nám...) theo thời gian thực",
    icon: ScanFace,
    className: "md:col-span-2 bg-[var(--color-panel)] border border-[var(--color-panel-border)]",
  },
  {
    title: "Chăm sóc cá nhân hoá",
    description: "Đề xuất sản phẩm và quy trình dưỡng da phù hợp với tình trạng da của bạn ngay hôm nay.",
    icon: Droplets,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {features.map((feature, i) => (
          <motion.div
            ...
            className={cn(
              "p-8 lg:p-10 px-5 md:px-6 lg:px-8 group relative overflow-hidden flex flex-col justify-between items-start",
              feature.className
            )}
          >
