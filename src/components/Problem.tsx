  ...
  return (
    <section className="py-32 bg-[var(--color-bg-dark)] relative" id="problem">
      <div className="max-w-[1024px] mx-auto px-12 text-center" ref={ref}>
        ...
        >
          Làn da thay đổi mỗi ngày do <span className="text-[var(--color-espresso)]">thời tiết, giấc ngủ, stress</span> và <span className="text-[var(--color-espresso)]">hoóc-môn.</span>
          <br /><br />
