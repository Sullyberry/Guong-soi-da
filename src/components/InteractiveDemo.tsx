    ...
    <section className="py-32 bg-[var(--color-bg-deep)] relative overflow-hidden" id="how-it-works">
      ...
      <div className="max-w-[1024px] mx-auto px-12 grid md:grid-cols-2 gap-16 items-center" ref={ref}>
        ...
        <div className="relative aspect-[3/4] max-w-sm mx-auto w-full">
          {/* Mirror Frame */}
          <div className="absolute inset-0 rounded-[300px_300px_0_0] border-[10px] border-[#111] bg-black shadow-2xl overflow-hidden flex flex-col justify-center items-center">
            ...
            <div className="absolute top-12 w-full px-8 flex justify-between items-start font-mono">
              <div>
                ...
                <div className="editorial-label !text-[8px] mt-1">Oct 24</div>
              </div>
              <div className="text-right">
                <div className="text-glow-blue text-sm">82%</div>
                <div className="editorial-label !text-[8px] mt-1">Hydration</div>
              </div>
            </div>
        ...
        <div>
          ...
          >
            ...
            <div className="space-y-4 pt-4">
              <div className="flex gap-4 items-center p-4 border border-[var(--color-panel-border)] bg-[var(--color-panel)]/50">
                <div className="w-8 h-8 flex items-center justify-center font-mono text-[10px] border border-white/20 text-white rounded-[2px] shrink-0">01</div>
                <div className="text-[14px] font-medium text-white/90">Đứng trước gương 3 giây</div>
              </div>
              <div className="flex gap-4 items-center p-4 border border-[var(--color-panel-border)] bg-[var(--color-panel)]/50">
                <div className="w-8 h-8 flex items-center justify-center font-mono text-[10px] border border-white/20 text-white rounded-[2px] shrink-0">02</div>
                <div className="text-[14px] font-medium text-white/90">Xem báo cáo mức độ tổn thương da</div>
              </div>
              <div className="flex gap-4 items-center p-4 border border-[var(--color-panel-border)] bg-[var(--color-panel)]/50">
                <div className="w-8 h-8 flex items-center justify-center font-mono text-[10px] border border-white/20 text-white rounded-[2px] shrink-0">03</div>
                <div className="text-[14px] font-medium text-white/90">Thực hiện routine được gợi ý trên màn hình</div>
              </div>
            </div>
          </motion.div>
        </div>
