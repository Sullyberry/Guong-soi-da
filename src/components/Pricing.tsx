  ...
  return (
    <section className="py-32 relative flex justify-center px-12 border-t border-[var(--color-panel-border)] bg-[var(--color-bg-dark)]" ref={ref} id="pricing">
      ...
      >
        ...
        <p className="text-[16px] text-[var(--color-espresso-muted)] leading-relaxed mb-12 max-w-md mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-12 mb-16">
          ...
          <div className="text-center md:text-left flex flex-col gap-2">
            ...
            <div className="text-[14px] text-[var(--color-espresso-muted)]">Giới hạn 500 slot đặt trước.</div>
            <div className="text-[14px] text-[var(--color-espresso-muted)] mt-1">Giao hàng dự kiến: Tháng 12, 2026.</div>
          </div>
        </div>
